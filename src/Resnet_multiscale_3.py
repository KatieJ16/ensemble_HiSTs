...
class ResNet(torch.nn.Module):
    def __init__(self, arch, dt, step_size, activation=torch.nn.ReLU()):
        ...
        self.add_module('mid', NNBlock(arch, activation=activation))
...
#         y_preds = torch.zeros(batch_size, n_steps, n_dim).float().to(self.device)
        ...
        layers = [['small', 0], #1
                  ...
                  ['mid','small','mid',4], 
                  ['small','mid','mid',4], 
                  ['mid', 'small', 'small', 'small',4],
                  [ 'small', 'mid','small', 'small',4],
                  ['small', 'small', 'mid', 'small',4],
                  ['small','small', 'small', 'mid',4],
                  ['small', 'small', 'small', 'small', 'small',4],
                  ['large', 'small', 'small',5], #6
                  ['small','large','small',5],
                  ['small', 'small', 'large',5],
                  ['large', 'mid',5],
                  ['mid', 'large',5],
                  ['mid','mid', 'small', 'small',5], 
                  ['small', 'mid','mid', 'small',5], 
                  ['small', 'mid','small','mid',5], 
                  ['mid','small','mid', 'small',5], 
                  ['mid', 'small', 'small', 'mid',5],
                  ['small', 'small', 'mid', 'mid',5],
                  ['mid','mid','mid',5], 
                  ['mid', 'small', 'small', 'small', 'small',5],
                  [ 'small', 'mid','small', 'small', 'small',5],
                  ['small', 'small', 'mid', 'small', 'small',5],
                  ['small','small', 'small', 'mid', 'small',5],
                  ['small', 'small','small', 'small', 'mid',5],
                  ['small', 'small', 'small', 'small', 'small', 'small',5]]
                  
                  
        for i in range(len(layers)):
#             print("i = ", i)
#             print("layers[i] = ", layers[i])
            y_next = self.forward(x, layers[i][0])
            for j in range(1, len(layers[i]) - 1):
                y_next = self.forward(y_next, layers[i][j])
            #add the amount of loss
            loss += criterion(y_next, ys[:,layers[i][-1],:])
...
#         ghj
    ...
    def train_net_single(self, dataset, max_epoch, batch_size, w=1.0, lr=1e-3, model_path=None, print_every=1000, type="large"):
        """
        :param dataset: a dataset object
        :param max_epoch: maximum number of epochs
        :param batch_size: batch size
