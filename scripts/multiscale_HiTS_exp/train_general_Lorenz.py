...
dt = 0.0005                    # time unit: 0.0005 for Lorenz and 0.01 for others
system = 'Lorenz'         # system name: 'Hyperbolic', 'Cubic', 'VanDerPol', 'Hopf' or 'Lorenz'
...
#     arch = [2, 128,128,128, 2]  # architecture of the neural network
    ...
    for step_size in [min(step_sizes)]:#,8,16,32]:
