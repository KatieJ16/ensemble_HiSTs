...
n_train = 20
multiplier = 32
total_steps = step_size * n_forward + 1
train_data_onestream = np.zeros((n_train, total_steps, 2))

for i in range(n_train):
        train_data_onestream[i] = train_data[0, multiplier*i:multiplier*i+total_steps]
        

print("train_data shape = ", train_data.shape)
print('train_data_onestream shape = ', train_data_onestream.shape)
print("val_data shape = ", val_data.shape)
print("test_data.shape = ", test_data.shape)


# create dataset object
dataset = net.DataSet(train_data_onestream, val_data, test_data, dt, step_size, n_forward)

#make and train
model_name = 'model_D{}_noise{}_onesteam{}.pt'.format(step_size, noise, n_train)
