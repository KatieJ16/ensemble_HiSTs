...
for noise in [0.0]:#, 0.01, 0.02, 0.05, 0.1, 0.2]:
    ...
    arch = [2, 512, 512, 512, 2]  # architecture of the neural network, VanDerPol
#     arch = [2, 128,128,128, 2]  # architecture of the neural network
#     arch=[3, 1024, 1024, 1024, 3] #Lorenz
...
#     model_dir = '../../models/VanDerPol_multiscale'
    ...
    for step_size in [smallest_step]:#,8,16,32]:
        ...
        for letter in ['b']:
            #make and train
            model_name = 'model_depends{}_noise{}_{}.pt'.format(step_size, noise, letter)
